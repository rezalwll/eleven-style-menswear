...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "فروشگاه اینترنتی پوشاک مردانه الون استایل؛ پیراهن، شلوار، تیشرت، کفش و اکسسوری.",
      },
      { name: "author", content: "Eleven Style" },
    ...
    <QueryClientProvider client={queryClient}>
      <CartProvider>
        <div className={isAdmin ? "min-h-screen" : "flex min-h-screen flex-col"}>
          {!isAdmin && <SiteHeader />}
          <main className={isAdmin ? "min-h-screen" : "flex-1 pb-10"}>
